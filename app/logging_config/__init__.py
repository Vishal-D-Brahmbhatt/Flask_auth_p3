...
from app.logging_config.log_formatters import RequestFormatter, csvfileformatter
...
LOGGING_CONFIG = {
    ...
    'formatters': {
        ...
        'csvfileformatter': {
            '()': 'app.logging_config.log_formatters.csvfileformatter',
            'format': '[%(asctime)s] %(levelname)s METHOD: %(request_method)s '
                      'NAME OF FILE:%(filename)s FUNCTION NAME:%(funcName)s()]'
                      ' %(message)s LOGGER: %(remote_addr)s'
        },
    ...
    'handlers': {
        ...
        'file.handler.csvfileformatter': {
            'class': 'logging.handlers.RotatingFileHandler',
            'formatter': 'csvfileformatter',
    ...
    'loggers': {
        ...
        'csvfileuploads': {  # if __name__ == '__main__'
            'handlers': ['file.handler.csvfileformatter'],
            'level': 'INFO',
            'propagate': False
        },
